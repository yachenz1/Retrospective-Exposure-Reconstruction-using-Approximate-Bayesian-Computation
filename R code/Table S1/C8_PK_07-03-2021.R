...
BrkmrReshx <- read.table("~/Desktop/PK Bayesian/data/BrkmrReshx_May3_savitzonly.csv", 
                         header = F, sep = ",")
BrkmrWorkhx <- read.table("~/Desktop/PK Bayesian/data/BrkmrWorkhx_savitzonly.csv", header = F, sep = ",")
...
water_consumption0 <- read.table("~/Desktop/PK Bayesian/data/Matlab code for body weight and water consumption rates over time/water_consumption0.csv",
                                 header = FALSE, sep = ",")
waterconsumption_2_11_2011 <- read.table("~/Desktop/PK Bayesian/data/Matlab code for body weight and water consumption rates over time/waterconsumption_2_11_2011.csv",
                                         header = TRUE, sep = ",")
...
C8.est.abc.1 <- C8.est[ , , exp(wt) != 0]  # acceptance rate = 35.9%
dim(C8.est.abc.1)
C8.est.abc <- C8.est[ , , exp(wt) >= 1e-300]  # acceptance rate = 33.3%
dim(C8.est.abc)
...
mean((C8.test$C8.measure - C8.test$C8.est.abc)^2)  # 8375.14
mean(abs(C8.test$C8.measure - C8.test$C8.est.abc))  # 29.55
...
for(i in 1:dim(C8.est.abc)[3]){   # 333
