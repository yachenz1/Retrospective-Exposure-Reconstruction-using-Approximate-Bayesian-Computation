...
C8.est.abc.1 <- C8.est[ , , exp(wt) != 0]  # acceptance rate = 37.6%
dim(C8.est.abc.1)
C8.est.abc <- C8.est[ , , exp(wt) > 1e-300]  # acceptance rate = 36.0%
dim(C8.est.abc)
...
mean((C8.test$C8.measure - C8.test$C8.est.abc)^2)  # 7198.79
mean(abs(C8.test$C8.measure - C8.test$C8.est.abc)) # 27.48
...
for(i in 1:dim(C8.est.abc)[3]){     # 360
