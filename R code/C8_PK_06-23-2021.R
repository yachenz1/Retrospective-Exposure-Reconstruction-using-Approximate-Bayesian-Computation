...
C8.est.abc.1 <- C8.est[ , , exp(wt) != 0]  # acceptance rate = 26.5%
dim(C8.est.abc.1)
C8.est.abc <- C8.est[ , , exp(wt) > 1e-300]  # acceptance rate = 24.0%
dim(C8.est.abc)
...
mean((C8.test$C8.measure - C8.test$C8.est.abc)^2) # 8192.02
mean(abs(C8.test$C8.measure - C8.test$C8.est.abc)) # 29.13
...
for(i in 1:dim(C8.est.abc)[3]){    # 240
